        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex items-center justify-center gap-1 lg:justify-start">
              <p className="text-2xl">ContentBoost</p>
              <Image
                src="/logo.png"
                alt="logo"
                height={30}
            ...
            <ul className="mt-5 flex justify-center gap-6 md:gap-8 lg:justify-start">
              <li>
                <a
                  href="/"
            ...
            <div className="text-center sm:text-left">
              ...
              <nav className="mt-5">
                <ul className="space-y-3 text-sm">
                  <li>
                    <a className="hover:/75 transition" href="/">
                      Company History
                    </a>
                  </li>
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <li>
                    <a
                      ...
                      href="/"
                    >
                      <span className="group-hover:/75 transition">
                        Live Chat
                      </span>
              ...
              <ul className="mt-5 space-y-3 text-sm">
                ...
                <li className="flex items-start justify-center gap-1.5 sm:justify-start">
                  ...
                  <address className="-mt-0.5 not-italic">
                    213 Lane, Cape Town, South Africa
                  </address>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
              &copy; 2024 ContentBoost (pyt) ltd.{" "}
